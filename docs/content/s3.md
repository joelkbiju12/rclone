...
Hetzner Object Storage is the S3-compatible storage solution that grows with your data requirements - highly available, secure and flexible. 
```
[hetzner]
type = s3
provider = Hetzner
...
Option endpoint.
Endpoint for Hetzner Object Storage API
Choose a number from below, or type in your own value.
Press Enter to leave empty.
 1 / Falkenstein
